...
Awesome resources for [Relay](https://github.com/facebook/relay) ⭐ 18,954 | 🐛 871 | 🌐 Rust | 📅 2026-08-18, based on the [Awesome](https://github.com/sindresorhus/awesome/) ⭐ 497,038 | 🐛 102 | 📅 2026-06-30 project
...
* [Facebook Relay talk - Lunch and Learn session](https://www.youtube.com/watch?v=sP3n-nht0Xo) - Walkthrough of building a simple app, and demonstration of [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,894 | 🐛 391 | 🌐 TypeScript | 📅 2026-08-11.
...
* [Relay TODO MVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 40 | 🌐 JavaScript | 📅 2026-08-14 - The classic TODO example app, written with Relay.
* [`koa-graphql-relay-example`](https://github.com/chentsulin/koa-graphql-relay-example) ⭐ 99 | 🐛 2 | 🌐 JavaScript | 📅 2016-11-28 - "TODO" app with [`koa-graphql`](https://github.com/chentsulin/koa-graphql) ⭐ 840 | 🐛 6 | 🌐 TypeScript | 📅 2023-01-24 and `relay`.
* [`relay-chat`](https://github.com/transedward/relay-chat) ⚠️ Archived - Relay with routing and pagination.
* [`todomvc-relay-go`](https://github.com/sogko/todomvc-relay-go) ⭐ 65 | 🐛 3 | 🌐 JavaScript | 📅 2016-08-03 - Relay TodoMVC app, driven by a Golang GraphQL backend.
...
* [`graphql-relay-js`](https://github.com/graphql/graphql-relay-js) ⭐ 1,541 | 🐛 24 | 🌐 TypeScript | 📅 2025-10-02 - Simplifies creating a JS GraphQL server for `react-relay`.
...
* [`relay-local-schema`](https://github.com/relay-tools/relay-local-schema) ⭐ 252 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-14 - Use a local schema; no need for a remote GraphQL server.
...
* [`sequelize-relay`](https://github.com/MattMcFarland/sequelize-relay) ⭐ 76 | 🐛 6 | 🌐 JavaScript | 📅 2018-10-19 - Make Relay compatible with [`sequelize`](https://github.com/sequelize/sequelize) ⭐ 30,375 | 🐛 1,076 | 🌐 TypeScript | 📅 2026-08-16.
* [`react-native-relay`](https://github.com/lenaten/react-native-relay) ⭐ 74 | 🐛 3 | 🌐 JavaScript | 📅 2016-03-24 - Use Relay with React Native.
  * May be supported [out of the box](https://github.com/facebook/relay/issues/26) ⭐ 18,954 | 🐛 871 | 🌐 Rust | 📅 2026-08-18 in the future.
...
* [`relay-decorator`](https://github.com/4Catalyzer/relay-decorators) ⚠️ Archived - Simply syntax for Relay containers with ES7 decorators (`@` syntax)
...
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,894 | 🐛 391 | 🌐 TypeScript | 📅 2026-08-11 - A library to introspect GraphQL, test queries and mutations.
  * [GraphiQL App](https://github.com/skevy/graphiql-app) ⭐ 2,969 | 🐛 87 | 🌐 JavaScript | 📅 2023-08-24 - A standalone app for viewing GraphQL, introspection docs, and testing queries/mutations. Invaluable for debugging your Relay app.
* [`relay-local-schema`](https://github.com/relay-tools/relay-local-schema) ⭐ 252 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-14 - Use a local schema; no need for a remote GraphQL server.
* [Babel Relay Plugin](https://www.npmjs.com/package/babel-relay-plugin) - Use Relay the latest ES6+ syntax.

## Starter Kits

* [Node.js API Starter Kit](https://github.com/kriasoft/nodejs-api-starter) ⭐ 3,971 | 🐛 9 | 🌐 TypeScript | 📅 2024-11-10 - Boilerplate and tooling for building data APIs with Node.js, GraphQL and Relay
...
* [Simple Relay Starter](https://github.com/mhart/simple-relay-starter) ⭐ 156 | 🐛 1 | 🌐 JavaScript | 📅 2017-01-28 - A Browserify version of the [Relay Starter Kit](https://github.com/relayjs/relay-starter-kit) ⚠️ Archived.
* [Relay Skeleton](https://github.com/fortruce/relay-skeleton) ⭐ 124 | 🐛 2 | 🌐 JavaScript | 📅 2016-02-22 - Relay project skeleton.
...
* [Go Relay](https://github.com/graphql-go/relay) ⭐ 423 | 🐛 8 | 🌐 Go | 📅 2020-12-09 - A Go/Golang library to help construct a graphql-go server supporting react-relay.
* [`todomvc-relay-go`](https://github.com/sogko/todomvc-relay-go) ⭐ 65 | 🐛 3 | 🌐 JavaScript | 📅 2016-08-03 - React/Relay TodoMVC app, driven by a Golang GraphQL backend.
...
* [`graphql-relay-py`](https://github.com/graphql-python/graphql-relay-py) ⭐ 144 | 🐛 12 | 🌐 Python | 📅 2023-02-27 - A library to help construct a `graphql-py` server supporting `react-relay`.
...
* [`sangria-relay`](https://github.com/sangria-graphql/sangria-relay) ⭐ 91 | 🐛 15 | 🌐 Scala | 📅 2026-06-07 - Relay support for [Sangria](http://sangria-graphql.org).
