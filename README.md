...
Awesome resources for [Relay](https://github.com/facebook/relay) ⭐ 18,963 | 🐛 861 | 🌐 Rust | 📅 2026-09-15, based on the [Awesome](https://github.com/sindresorhus/awesome/) ⭐ 506,498 | 🐛 106 | 📅 2026-09-02 project
...
* [Facebook Relay talk - Lunch and Learn session](https://www.youtube.com/watch?v=sP3n-nht0Xo) - Walkthrough of building a simple app, and demonstration of [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,906 | 🐛 388 | 🌐 TypeScript | 📅 2026-09-15.
...
* [Relay TODO MVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 41 | 🌐 JavaScript | 📅 2026-09-15 - The classic TODO example app, written with Relay.
...
* [`react-router-relay`](https://github.com/relay-tools/react-router-relay) ⭐ 555 | 🐛 1 | 🌐 JavaScript | 📅 2019-07-26 - `react-router` bindings for Relay. Greatly simplifies many local state UI uses cases.
...
* [`relay-local-schema`](https://github.com/relay-tools/relay-local-schema) ⭐ 252 | 🐛 14 | 🌐 JavaScript | 📅 2026-09-15 - Use a local schema; no need for a remote GraphQL server.
...
* [`sequelize-relay`](https://github.com/MattMcFarland/sequelize-relay) ⭐ 76 | 🐛 6 | 🌐 JavaScript | 📅 2018-10-19 - Make Relay compatible with [`sequelize`](https://github.com/sequelize/sequelize) ⭐ 30,364 | 🐛 1,078 | 🌐 TypeScript | 📅 2026-09-16.
* [`react-native-relay`](https://github.com/lenaten/react-native-relay) ⭐ 74 | 🐛 3 | 🌐 JavaScript | 📅 2016-03-24 - Use Relay with React Native.
  * May be supported [out of the box](https://github.com/facebook/relay/issues/26) ⭐ 18,963 | 🐛 861 | 🌐 Rust | 📅 2026-09-15 in the future.
...
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,906 | 🐛 388 | 🌐 TypeScript | 📅 2026-09-15 - A library to introspect GraphQL, test queries and mutations.
...
* [Node.js API Starter Kit](https://github.com/kriasoft/nodejs-api-starter) ⭐ 3,973 | 🐛 9 | 🌐 TypeScript | 📅 2024-11-10 - Boilerplate and tooling for building data APIs with Node.js, GraphQL and Relay
...
* [Relay Fullstack](https://github.com/lvarayut/relay-fullstack) ⭐ 978 | 🐛 6 | 🌐 JavaScript | 📅 2017-11-25 - Relay Starter Kit integrated with Relay, Express, Webpack, Babel, Material Design Lite, and PostCSS.
...
* [`graphql-relay-py`](https://github.com/graphql-python/graphql-relay-py) ⭐ 143 | 🐛 12 | 🌐 Python | 📅 2023-02-27 - A library to help construct a `graphql-py` server supporting `react-relay`.
...
* [`sangria-relay`](https://github.com/sangria-graphql/sangria-relay) ⭐ 91 | 🐛 14 | 🌐 Scala | 📅 2026-09-05 - Relay support for [Sangria](http://sangria-graphql.org).
