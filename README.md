...
Awesome resources for [Relay](https://github.com/facebook/relay) ⭐ 18,964 | 🐛 864 | 🌐 Rust | 📅 2026-09-25, based on the [Awesome](https://github.com/sindresorhus/awesome/) ⭐ 510,610 | 🐛 107 | 📅 2026-09-02 project
...
* [Facebook Relay talk - Lunch and Learn session](https://www.youtube.com/watch?v=sP3n-nht0Xo) - Walkthrough of building a simple app, and demonstration of [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,911 | 🐛 390 | 🌐 TypeScript | 📅 2026-09-17.
...
* [Relay TODO MVC](https://github.com/taion/relay-todomvc) ⭐ 158 | 🐛 41 | 🌐 JavaScript | 📅 2026-09-25 - The classic TODO example app, written with Relay.
...
* [`graphql-relay-js`](https://github.com/graphql/graphql-relay-js) ⭐ 1,542 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-21 - Simplifies creating a JS GraphQL server for `react-relay`.
...
* [`sequelize-relay`](https://github.com/MattMcFarland/sequelize-relay) ⭐ 76 | 🐛 6 | 🌐 JavaScript | 📅 2018-10-19 - Make Relay compatible with [`sequelize`](https://github.com/sequelize/sequelize) ⭐ 30,363 | 🐛 1,119 | 🌐 TypeScript | 📅 2026-09-26.
* [`react-native-relay`](https://github.com/lenaten/react-native-relay) ⭐ 74 | 🐛 3 | 🌐 JavaScript | 📅 2016-03-24 - Use Relay with React Native.
  * May be supported [out of the box](https://github.com/facebook/relay/issues/26) ⭐ 18,964 | 🐛 864 | 🌐 Rust | 📅 2026-09-25 in the future.
...
* [GraphiQL](https://github.com/graphql/graphiql) ⭐ 16,911 | 🐛 390 | 🌐 TypeScript | 📅 2026-09-17 - A library to introspect GraphQL, test queries and mutations.
...
* [Node.js API Starter Kit](https://github.com/kriasoft/nodejs-api-starter) ⭐ 3,970 | 🐛 9 | 🌐 TypeScript | 📅 2024-11-10 - Boilerplate and tooling for building data APIs with Node.js, GraphQL and Relay
...
* [`sangria-relay`](https://github.com/sangria-graphql/sangria-relay) ⭐ 91 | 🐛 10 | 🌐 Scala | 📅 2026-09-24 - Relay support for [Sangria](http://sangria-graphql.org).
